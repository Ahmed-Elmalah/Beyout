...
const Hero = () => {
  const handleConsultation = () => {
    const message = "Hello Beyout, I am interested in booking a Free servay for my home.";
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-6 w-full grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col gap-6">
          ...
          <h1 className="text-5xl md:text-7xl font-bold leading-tight tracking-tight text-white">
            ...
            <span className="text-transparent bg-clip-text bg-linear-to-r from-primary to-blue-500 text-glow">
              Living Intelligence
            </span>
            .
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-4">
            <Button onClick={handleConsultation} className="py-4 px-8">Get Your Free Survey</Button>
          </div>
        </div>
          ...
          <GlassPanel className="p-6 max-w-sm w-full transform translate-y-12 animate-float shadow-2xl">
            ...
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs text-black dark:text-gray-400 uppercase">
                    Living Room
                  </p>
